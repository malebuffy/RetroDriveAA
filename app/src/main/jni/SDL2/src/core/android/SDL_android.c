...
/* Relative Mouse Motion (for trackpad/mouse emulation) */
JNIEXPORT void JNICALL Java_org_libsdl_app_SDLActivity_onNativeMouseRelative(
                                    JNIEnv* env, jclass jcls,
                                    jfloat dx, jfloat dy)
{
    Android_OnMouseRelative(dx, dy);
}
